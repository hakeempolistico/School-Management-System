        ...
        foreach ($result as $value)
            {	            	
				...
				if(!$e_info){
                    ...
                    <button data-toggle="modal" class="btn btn-xs btn-info"><i class="fa fa-ban"></i></button>';
				}else{
					$btn = '
                    ...
                    <button data-toggle="modal" data-target="#modal-confirm-reset" class="btn btn-xs btn-reset btn-danger"><i class="fa fa-key"></i></button>
